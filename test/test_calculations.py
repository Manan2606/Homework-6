...
def test_get_history(calculations_setup):
...
def test_clear_history(calculations_setup):
    """Test clearing the entire calculation history."""
    Calculations.clear_history()
    assert len(Calculations.get_history()) == 0, "History was not cleared"

def test_get_latest(calculations_setup):
...
def test_find_by_operation(calculations_setup):
